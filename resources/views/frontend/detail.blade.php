                    ...
                    <div class="row m-sm-0">
                        ...
                        <div class="col-sm-10 order-1 order-sm-2">
                            <div class="owl-carousel product-slider" data-slider-id="1"><a class="d-block"
                                    ="{{ asset('frontend/img/product-detail-1.jpg') }}" data-lightbox="product" title="Product item 1"><img
                                    ...
                                    title="Product item 2"><img class="img-fluid" src="{{ asset('frontend/img/product-detail-2.jpg') }}"
                                        alt="..."></a><a class="d-block" href="{{ asset('frontend/img/product-detail-3.jpg') }}"
                                    ...
                                    href="{{ asset('frontend/img/product-detail-4.jpg') }}" data-lightbox="product" title="Product item 4"><img
