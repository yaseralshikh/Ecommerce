        ...
        <header class="header bg-white">
            <div class="container px-0 px-lg-3">
                <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand"
                        href="{{ route('frontend.index') }}"><span class="font-weight-bold text-uppercase text-dark">Boutique</span></a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('backend.login') }}"> <i class="fas fa-user-alt mr-1 text-gray"></i>Login</a>
                            </li>
                        </ul>
                    </div>
                </nav>
                ...
                <div class="modal-body p-0">
                    <div class="row align-items-stretch">
                        <div class="col-lg-6 p-lg-0"><a class="product-view d-block h-100 bg-cover bg-center"
                                style="background: url(../frontend/img/product-5.jpg)" href="{{ asset('frontend/img/product-5.jpg') }}"
                            ...
                            <div class="p-5 my-md-4">
                                ...
                                <div class="row align-items-stretch mb-4">
                                    ...
                                    <div class="col-sm-5 pl-sm-0"><a
                                        ...
                                        class="far fa-heart mr-2"></i>Add to
                                    wish list</a>
                            </div>
                        </div>
                    </div>
